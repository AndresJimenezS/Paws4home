...
import com.paws4home.service.CorreoService;
import com.paws4home.service.RegistroService;
...
//        }
        boolean activarUsuario = (roles == null || roles.isEmpty());

        usuarioService.save(usuario, activarUsuario);
    }
